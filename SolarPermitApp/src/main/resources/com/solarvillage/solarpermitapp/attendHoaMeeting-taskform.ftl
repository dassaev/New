...
<div id="container">
	<div id="header">
		User Task Form: new-order-permitting.attendHoaMeeting
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<![CDATA[[users:|groups:executive]@[3M]]]>
                            		</div>
                            		...
                            		<div class="div_checkbox">
                              		<![CDATA[[from:|tousers:|togroups:sales|replyTo:|subject:Task Reassigned|body:This task has been reassigned to executive.]@[3M]]]>
                            		</div>
